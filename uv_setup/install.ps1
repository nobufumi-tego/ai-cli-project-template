...
Write-Host "    1. 環境診断（何が揃っているか確認）:"
Write-Host "       uv run python scripts/check-setup.py"
Write-Host ""
Write-Host "    2. プロジェクト初期化（対話形式）:"
Write-Host "       uv run python scripts/init-project.py"
Write-Host ""
Write-Host "  JupyterLab を起動する場合:"
